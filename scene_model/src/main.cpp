...
int main() {
    ...
    // Watch Tower Position and Scale
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // send lighting and camera uniforms
        ...
        // COMMON uniforms for all objects
        ...
        if (VAO_tower) {
            ...
            modelTower = glm::rotate(modelTower, glm::radians(0.0f), glm::vec3(1.0f, 0.0f, 0.0f));
            modelTower = glm::rotate(modelTower, glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
...
bool loadOBJ(const std::string& path, std::vector<Vertex>& outVertices, GLuint& outTexture) {
    ...
    // Output message to confirm loading (was the original debug message)
